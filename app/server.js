...
controller.hears(['help'], ['direct_message', 'direct_mention', 'mention'], (bot, message) => {
  bot.reply(message, 'Want to know about the weather outside or anywhere in the world? Simply ask me something like \'How\'s the weather?\', and I\'ll get you a full report!');
  bot.reply(message, 'Hungry? Tell me! Let me know \'I\'m hungry\', for example, and I\'ll help you find just what you\'re looking for');
});
...
controller.on('outgoing_webhook', (bot, message) => {
  ...
  //   unfurl_media: true,
  // };
  bot.replyPublic(message, 'Just a quick sip of coffee and I\'ll be ready http://giphy.com/gifs/coffee-gif-brockurealities-DrJm6F9poo4aA');
});
